<?php
    ...
    if(isset($_POST['id']) && isset($_POST['pass'])){
        ...
        $sql = "SELECT * FROM admin WHERE staff_no = '".$id."' AND password = '".$pass."'";
        ...
        if($res){
            if(mysqli_num_rows($res) > 0){
                ...
                $_SESSION['adminId'] = $data['staff_no'];
                ...
                $loginError = "Invalid Staff Credentials!";
            }
        } 
    }
?>
    ...
    <section class="login-container">
        <div class="login">
            ...
            <form action="" method="post">
                ...
                <div>
                    <p>Staff Number</p>
                    <input type="text" name="id" id="id" placeholder="Enter Your Staff Number" required>
                </div>
                ...
                <div>
                    ...
                    <br>
                    <a href="./admin" style="display: flex; justify-content: center;">Student Login</a>
                </div>
            </form>
        </div>
    </section>
